...
namespace cts {
    ...
    namespace spsc {
        ...
        namespace detail {
            ...
            public:
                ...
                [[nodiscard]] auto capacity() const noexcept { return index_mask_ + 1; }
            };
        ...
        public:
            ...
            [[nodiscard]] auto capacity() const noexcept -> size_t {
                return index_policy_.capacity();
            }

            [[nodiscard]] auto size() const noexcept -> size_t {
                auto tx_count = tx_count_.load(std::memory_order_acquire);
                auto rx_count = rx_count_.load(std::memory_order_acquire);
        ...
        > [[nodiscard]] auto channel_bounded_fast(
            ...
            using Channel = Channel<T,Allocator,detail::IndexPolicyMasking>;
        ...
        > [[nodiscard]] auto channel_bounded(
            ...
            using Channel = Channel<T,Allocator,detail::IndexPolicyModulo>;
            return Channel{capacity, allocator};
        }
    ...
    class ChannelTx<T,spsc::Channel<T,Allocator,IndexPolicy>> {

        using Channel = spsc::Channel<T,Allocator,IndexPolicy>;
        friend Channel;
    ...
    template <typename T, typename Allocator, typename IndexPolicy>
    class ChannelRx<T,spsc::Channel<T,Allocator,IndexPolicy>> {
